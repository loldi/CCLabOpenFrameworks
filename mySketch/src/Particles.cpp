...
void Particle::setup(){
    ...
    // Loading the Shaders
    updatePos.load("/Applications/openFrameworks/examples/gl/gpuParticleSystemExample/bin/data/shaders/posUpdate.frag");// shader for updating the texture that store the particles position on RG channels
    updateVel.load("/Applications/openFrameworks/examples/gl/gpuParticleSystemExample/bin/data/shaders/velUpdate.frag");// shader for updating the texture that store the particles velocity on RG channels
    ...
    updateRender.load("/Applications/openFrameworks/examples/gl/gpuParticleSystemExample/bin/data/shaders/render.vert","/Applications/openFrameworks/examples/gl/gpuParticleSystemExample/bin/data/shaders/render.frag","/Applications/openFrameworks/examples/gl/gpuParticleSystemExample/bin/data/shaders/render.geom");
    ...
    sparkImg.loadImage("/Applications/openFrameworks/examples/gl/gpuParticleSystemExample/bin/data/spark.png");
